...
var CKEditor = exports.CKEditor = (_dec = (0, _core.Component)({
...
}), _dec2 = (0, _core.Input)(), _dec3 = (0, _core.Input)(), _dec4 = (0, _core.Output)(), _dec5 = (0, _core.ViewChild)('host'), _dec6 = (0, _core.ViewChild)('hostInline'), _dec7 = (0, _core.Input)(), _dec(_class = (_class2 = function () {
  ...
  function CKEditor(elementRef, zone) {
    ...
    _initDefineProp(this, 'hostInline', _descriptor5, this);
  ...
  _createClass(CKEditor, [{
    ...
    key: 'updateValue',
    value: function updateValue(value, noEmit) {
      var _this = this;
    ...
    value: function ckeditorInit(config) {
      ...
      if (!config.inline) {
        ...
        (function () {
          _this2._inline = true;
          _this2.instance = CKEDITOR.inline(_this2.hostInline.nativeElement, config);

          // Get initial content
          var value = _this2.hostInline.nativeElement.innerHTML;
          _this2._firstWriteValue = true;
...
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, 'hostInline', [_dec6], {
  enumerable: true,
  initializer: function initializer() {
    return this.hostInline;
  }
