    ...
    */
    ...
    value: function onValueChange(value) {
      ...
      this.zone.run(function () {
        ...
        if (_this.ngControl) _this.ngControl.viewToModelUpdate(value);
      });
    }
...
Reflect.defineMetadata('design:paramtypes', [_core.ElementRef, _forms.NgControl, _core.NgZone], CKEditor);
